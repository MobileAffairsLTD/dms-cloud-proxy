...
function handleRegisterRawEInvoiceRequest(appArea: string, parser: Document): string {
...
export function processByRequestType(apiKey: string, appArea: string, requestType: string, xml: string): { transformedRequest: string; skipUplinkRequest: boolean } {
    ...
    if (parser) {
        ...
        switch (requestType.toUpperCase()) {
            ...
            case 'RegisterEInvoiceRequest'.toUpperCase(): return { transformedRequest: handleRegisterRawEInvoiceRequest(appArea, parser), skipUplinkRequest: false };
