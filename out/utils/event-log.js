...
function flushToCloud() {
    return __awaiter(this, void 0, void 0, function () {
        var _body, client, bulkResponse, erroredDocuments_1, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    if (!(EventLog.logEntries.length > 0)) return [3 /*break*/, 3];
                    client = new elasticsearch_1.Client({ auth: { username: 'dms-api', password: 'ABVabv123@#dmsapi202101' }, node: 'https://search-dms-eventlog-c5z66rz7wlq525ywntgyzeomnm.us-east-1.es.amazonaws.com' });
                    EventLog.logEntries.forEach(function (r) {
                        _body.push({ create: { _index: 'dms' } });
                        _body.push(r);
                    });
                    return [4 /*yield*/, client.bulk({ body: _body })];
                case 2:
                    ...
                    if (bulkResponse.errors) {
                        ...
                        throw erroredDocuments_1[0].toString();
                    }
                    _a.label = 3;
                ...
                case 4:
                    ...
                    if (err_1) {
                        ...
                        console.log("ERROR: Unable to insert event: ", err_1);
                    }
