            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, alf_requestType_request_1.processByRequestType(appArea, requestType, xml)];
                    case 1:
                        _a = _b.sent(), transformedRequest = _a.transformedRequest, skipUplinkRequest = _a.skipUplinkRequest;
                        successResponse = false;
                        response = void 0;
                        if (!!skipUplinkRequest) return [3 /*break*/, 9];
                    ...
                    case 2:
                        ...
                        if (!(requestType.toUpperCase() == 'RegisterEinvoiceRequest'.toUpperCase() ||
                            ...
                            requestType.toUpperCase() == 'EinvoiceChangeStatusRequest'.toUpperCase())) return [3 /*break*/, 4];
                        return [4 /*yield*/, alf_request_1.executeRequestEinvoice(signedRequest, isProduction)];
                    case 3:
                        response = _b.sent();
                        return [3 /*break*/, 6];
                    case 4: return [4 /*yield*/, alf_request_1.executeRequest(signedRequest, isProduction)];
                    case 5:
                        response = _b.sent();
                        _b.label = 6;
                    case 6:
